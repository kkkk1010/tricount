...
public class SettlementService {
    ...
    public List<BalanceResult> getBalanceResult(Long settlementId) {
        ...
        Map<Member, BigDecimal> calcuratedAmountMap = memberAmountSumMap.entrySet().stream()
                .collect(Collectors.toMap(Map.Entry::getKey, memberBigDecimalEntry -> memberBigDecimalEntry.getValue().subtract(averageAmount)));
